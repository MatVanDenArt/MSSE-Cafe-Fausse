...
python app.py
```
*Keep this terminal open - you should see "Running on http://127.0.0.1:5000"*
...
npm start
```
*Keep this terminal open - you should see "Local: http://localhost:3000"*
...
- `run_demo_tests.bat` - One-click demo runner
- `backend/demo_tests.py` - Main test suite
- `backend/view_data.py` - Database viewer
- `backend/TEST_SUITE_README.md` - Detailed documentation
