  ...
  return (
    <div className="home">
      ...
      >
        ...
        <section className="section" style={{ padding: "8rem 0 4rem" }}>
          <div className="container">
            <div className="section-title">
              <p>testimonials</p>
            ...
            <div className="testimonials-grid">
              <div className="testimonial">
                ...
                <div className="testimonial-content">
                  ...
                  <blockquote>
                    "An absolute gem. It felt like I was back in Paris. The
                    French Onion Soup is a must-try. We will be back, again and
                    again."
                  </blockquote>
              ...
              <div className="testimonial">
                ...
                <div className="testimonial-content">
                  ...
                  <blockquote>
                    "The ambiance is unmatched, and the food transports you
                    straight to a Parisian bistro. Every dish was perfection.
                    Truly a memorable dining experience."
                  </blockquote>
                  <div className="testimonial-author">
                    <div className="testimonial-author-info">
                      <cite className="testimonial-name">Michael Chen</cite>
