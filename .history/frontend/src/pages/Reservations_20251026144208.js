    ...
    <div className="reservations">
      <div className="container">
        <div className="section-title">
          ...
          <p>
            We look forward to welcoming you to Café Fausse. Please fill out the
            form below to reserve your table. We recommend making reservations
          ...
          <div className="reservation-info">
            <div className="info-card">
              ...
              <ul>
                ...
                <li>
                  Please call us if you need to cancel or modify your
                  reservation
                </li>
