...
backend\run_system_health_check.bat
...
- `backend/run_system_health_check.bat` - One-click demo runner
- `backend/test._system_health_check.py` - Main test suite (comprehensive system health check)
