    ...
    const fetchRestaurantInfo = async () => {
      try {
        const response = await fetch(
          "http://localhost:5000/api/restaurant-info"
        );
        if (response.ok) {
  ...
  return (
    <div className="home">
      ...
      <section
        className="hero"
        style={{
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/images/Home - Cafe Fausse.webp') !important",
            ...
            <div className="contact-info">
              <div className="grid grid-2">
                ...
                <div>
                  <h3>Hours</h3>
                  <p>
                    Monday – Saturday: {restaurantInfo.hours.monday_saturday}
                  </p>
