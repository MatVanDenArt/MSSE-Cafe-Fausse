        ...
        <div className="awards-carousel-header">
          <div className="awards-header-container">
            <div className="section-title">
              ...
              <p>
                We are honored to have received recognition for our commitment
                to excellence
              </p>
            </div>
          </div>
        ...
        <section className="about-section">
          ...
          <div className="values-grid">
            <div className="value-card">
              ...
              <h4>Authenticity</h4>
              <p>
                We stay true to traditional French cooking methods and flavors,
                ensuring every dish is authentic and memorable.
              </p>
            </div>
            <div className="value-card">
              <div className="value-icon">🌱</div>
              ...
              <p>
                We source ingredients responsibly, supporting local farmers and
            ...
            <div className="value-card">
              ...
              <h4>Hospitality</h4>
              <p>
                Every guest is treated like family, with warm service that makes
