...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const scrollContainer =
      cardsScrollRef.current?.querySelector(".cards-scroll");
    if (scrollContainer && isMobile) {
      scrollContainer.addEventListener("scroll", handleScroll, {
        passive: true,
      });
  ...
  }, [isMobile, currentCardIndex, cards.length]);
    ...
    <div className="home">
      ...
      >
        ...
        <section className="section">
          <div className="container">
            <div
              className={`cards-container ${isMobile ? "cards-carousel" : ""}`}
              ref={cardsScrollRef}
            >
              <div className={isMobile ? "cards-scroll" : "grid grid-3"}>
