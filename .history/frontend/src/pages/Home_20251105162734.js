            ...
            <div className="testimonial">
              <div className="testimonial-quote-icon">
                ...
                >
                  ...
                  />
                  <path
                    d="M6.5 7C6.5 5.07 8.07 3.5 10 3.5C11.93 3.5 13.5 5.07 13.5 7C13.5 8.93 11.93 10.5 10 10.5C9.74 10.5 9.49 10.47 9.25 10.41C8.99 10.35 8.76 10.25 8.55 10.13C8.34 10.01 8.16 9.86 8.01 9.68C7.86 9.5 7.74 9.29 7.65 9.05C7.56 8.81 7.5 8.55 7.5 8.25V7H6.5Z"
                    fill="#C19B66"
                  />
                  <path
                    d="M14.5 7C14.5 5.07 16.07 3.5 18 3.5C19.93 3.5 21.5 5.07 21.5 7C21.5 8.93 19.93 10.5 18 10.5C17.74 10.5 17.49 10.47 17.25 10.41C16.99 10.35 16.76 10.25 16.55 10.13C16.34 10.01 16.16 9.86 16.01 9.68C15.86 9.5 15.74 9.29 15.65 9.05C15.56 8.81 15.5 8.55 15.5 8.25V7H14.5Z"
                    fill="#C19B66"
                  />
                </svg>
              </div>
