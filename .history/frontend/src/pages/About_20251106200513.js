...
const About = () => {
  ...
  // Auto-scrolling infinite carousel for desktop
  useEffect(() => {
    const container = scrollContainerRef.current;
    if (!container || !isDesktop) return;

    let animationId = null;
    const scrollSpeed = 2.0; // Scroll speed in pixels per frame
        ...
        <div className="section-title">
          ...
          <p className="section-description">
            ...
            <span className="mobile-text">
              Café Fausse is more than a restaurant; it's a journey through
              French cuisine where tradition meets innovation.
            </span>
          </p>
        </div>
